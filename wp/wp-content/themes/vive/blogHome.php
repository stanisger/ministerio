            ...
            <div class="col s12 m4 l4">
                <div class="card">
                    ...
                    <div class="card-content">
                        <span class="card-title activator grey-text text-darken-4">Día del niño <i class="mdi-navigation-more-vert right"></i></span>
                        <p><a href="#">12/12/2015</a></p>
                    </div>
                    <div class="card-reveal">
                        <span class="card-title grey-text text-darken-4">Día del niño <i class="mdi-navigation-close right"></i></span>
                        <p>Here is some more information about this project that is only revealed once clicked on.</p>
                         <a class="center" href="#">Leer nota</a>
                    </div>
                </div>
            </div>
            <div class="col s12 m4 l4">
